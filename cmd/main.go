...
import (
	...
	"github.com/terra-consults/logbase/internal/datastore/postgres"
	"github.com/terra-consults/logbase/internal/pkg/cache/rediscache"
	"github.com/terra-consults/logbase/internal/pkg/email"
	"github.com/terra-consults/logbase/internal/pkg/email/resend"
	"github.com/terra-consults/logbase/internal/pkg/googleauth"
	"github.com/terra-consults/logbase/internal/pkg/jwttoken"
	watermillqueue "github.com/terra-consults/logbase/internal/pkg/queues/watermill"
	"github.com/terra-consults/logbase/internal/pkg/util"
	"github.com/terra-consults/logbase/server"
	"go.uber.org/zap"
)
...
func main() {
	...
	srv, cleanupSrv := server.New(
		...
		resourceRepo, apiKeyRepo, planRepo, passwordRepo,
		auditLogRepo,
	)
