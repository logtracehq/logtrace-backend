...
//
//	mockgen -source=organization.go -destination=mocks/organization.go -package=logtrace_mocks
//
...
func (m *MockOrganizationRepository) Create(arg0 context.Context, arg1 *logtrace.Organization) (*logtrace.Organization, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1)
	ret0, _ := ret[0].(*logtrace.Organization)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockOrganizationRepository) Delete(arg0 context.Context, arg1 *logtrace.FindOrganizationOptions) error {
	m.ctrl.T.Helper()
...
func (m *MockOrganizationRepository) List(arg0 context.Context, arg1 logtrace.FindOrganizationOptions) (*logtrace.Organization, error) {
	m.ctrl.T.Helper()
...
func (m *MockOrganizationRepository) ListAll(arg0 context.Context, arg1 *logtrace.FindOrganizationOptions) ([]logtrace.Organization, int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockOrganizationRepository) Update(arg0 context.Context, arg1 *logtrace.Organization) (*logtrace.Organization, error) {
	m.ctrl.T.Helper()
