...
func (m *MockUserRepository) List(arg0 context.Context, arg1 *logbase.FindUserOptions) (*logbase.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) ListAll(arg0 context.Context, arg1 *logbase.FindUserOptions) ([]*logbase.User, int64, error) {
	m.ctrl.T.Helper()
